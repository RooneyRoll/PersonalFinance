...
-- Started on 2017-12-24 15:26:22
...
--
-- TOC entry 2230 (class 0 OID 16442)
-- Dependencies: 183
...
--
-- TOC entry 2231 (class 0 OID 16446)
-- Dependencies: 184
...
--
-- TOC entry 2232 (class 0 OID 16452)
-- Dependencies: 185
-- Data for Name: payment_types; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO payment_types (ptype_name, ptype_description, ptype_active, ptype_id) VALUES ('Приходи', NULL, true, 1);
INSERT INTO payment_types (ptype_name, ptype_description, ptype_active, ptype_id) VALUES ('Разходи', NULL, true, 2);
INSERT INTO payment_types (ptype_name, ptype_description, ptype_active, ptype_id) VALUES ('Спестявания', NULL, true, 3);
...
--
-- TOC entry 2234 (class 0 OID 16460)
-- Dependencies: 187
...
--
-- TOC entry 2235 (class 0 OID 16466)
-- Dependencies: 188
...
--
-- TOC entry 2236 (class 0 OID 16469)
-- Dependencies: 189
...
--
-- TOC entry 2237 (class 0 OID 16475)
-- Dependencies: 190
-- Data for Name: recurring_types; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO recurring_types (rt_name, rt_id) VALUES ('Дневно', 1);
INSERT INTO recurring_types (rt_name, rt_id) VALUES ('Седмично', 2);
INSERT INTO recurring_types (rt_name, rt_id) VALUES ('Месечно', 3);
INSERT INTO recurring_types (rt_name, rt_id) VALUES ('Годишно', 4);
...
--
-- TOC entry 2239 (class 0 OID 16483)
-- Dependencies: 192
...
SELECT pg_catalog.setval('user_role_gen_id', 1, true);


--
-- TOC entry 2241 (class 0 OID 16488)
-- Dependencies: 194
...
--
-- TOC entry 2242 (class 0 OID 16495)
-- Dependencies: 195
...
-- Completed on 2017-12-24 15:26:22
