...
<script>
    $(document).ready(function () {
        $("#budget-category-add-form").validate({
            rules: {
                amount: {"required":true,"number":true}
            },
            messages: {
                amount: "Моля въведете лимит.",
            },
...
<div class="form-container">
    <c:if test="${errorMessage != null}"><tiles:insertAttribute name="categoryAddError" /></c:if>
        <div class="form-content">
            <form id="budget-category-add-form" method="post">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            <div class="input-container size-1">
                <div class="input-title-holder no-select">
                    <span> 
                        Лимит на категорията<span class="required-tip">&nbsp;*</span>
                    </span>
                </div>
                <div class="input-holder">
                    <input type="text" name="amount" placeholder="Лимит"/>
                </div>
            </div>
            ...
            <div class="input-container size-2">
                ...
                <div class="input-title-holder no-select">
                    <span> 
                        Категория<span class="required-tip">&nbsp;*</span>
                    </span>
                </div>
                <div class="input-holder">
