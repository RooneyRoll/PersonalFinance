...
<script>
    $(document).ready(function () {
        $("#payment-type-edit-form").validate({
            ...
            messages: {
                typeName: "Моля, въведете име на категория",
            },
        ...
        <div class="form-content">
            ...
            <div class="input-container size-2">
                <div class="input-title-holder no-select">
                    <span> 
                        Име на тип на плащания<span class="required-tip">&nbsp;*</span>
                    </span>
                </div>
                <div class="input-holder">
                    <input type="text" name="typeName" placeholder="Име" id="password" value="${type.getName()}"/>
                </div>
                ...
                <div class="input-holder">
                    <input  type="radio" <c:if test="${type.isActive()}">checked="checked"</c:if>
                            name="typeActive" value="1"/><label
                        class="visible">типът е активен</label><input type="radio" <c:if test="${type.isActive() == false}">checked="checked"</c:if>
                           name="typeActive" value="2"/><label>
                        типът не е активен</label>
                </div>
            </div><div class="input-container size-1">
                <div class="input-title-holder no-select">
                    <span> 
                        Описание на тип на плащания
                    </span>
                </div>
                <div class="input-holder">
                    <textarea resize="false" placeholder="Описание" name="typeDescription">${type.getDescription()}</textarea>
                </div>
            </div>
