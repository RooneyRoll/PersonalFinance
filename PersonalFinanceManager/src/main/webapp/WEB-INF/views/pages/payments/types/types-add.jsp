...
<script>
    $(document).ready(function () {
        $("#payment-type-add-form").validate({
            ...
            messages: {
                typeName: "Моля, въведете име на тип на плащания",
            },
        ...
        <div class="form-content">
            ...
            <div class="input-container size-1">
                <div class="input-title-holder no-select">
                    <span> 
                        Име на тип на плащане<span class="required-tip">&nbsp;*</span>
                    </span>
                </div>
                <div class="input-holder">
                    <input type="text" name="typeName" placeholder="Име" id="password"/>
                </div>
                ...
                <div class="input-holder">
                    <textarea resize="false" placeholder="Описание" name="typeDescription"></textarea>
                </div>
            </div>
