    ...
    <div class="footer-content">
        <div class="footer-left">
            ...
            <div class="footer-col">
                <i class="fa fa-users"></i><div class="text">Екип:</div><br>
                <i class="fa fa-address-book-o"></i><div class="text">Методи Младенов <br>|&nbsp;Product owner <br>|&nbsp;Ф.Н:&nbsp;</div><br>
                <i class="fa fa-address-book-o"></i><div class="text">Емануела Миланова <br>|&nbsp;Scrum master <br>|&nbsp;Ф.Н:&nbsp;</div><br>
                <i class="fa fa-address-book-o"></i><div class="text">Иван Йорданов <br>|&nbsp;Scrum master(2) <br>|&nbsp;Ф.Н:&nbsp;25409</div><br>
                ...
                <i class="fa"></i><div class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;000000000</div><br>
                <i class="fa"></i><div class="text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;000000000</div><br>
            </div><div class="footer-col">
                <i class="fa"></i><div class="text">Полезни връзки:</div><br>
                <i class="fa fa-question-circle"></i><div class="text"><a src="www.spring.io">Spring Framework</a></div><br>
